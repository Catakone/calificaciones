                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-5">
                            <div>
                                ...
                                <input type="email" name="name" id="username" className="font-questrial bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-md focus:ring-primary-600 focus:border-primary-600 block w-11/12 ml-2 p-2.5" placeholder="Uwu Perez" required=""/>
                            </div>
                            <div>
                                <label className="font-questrial text-left block mb-1 text-sm font-medium text-gray-900 dark:text-white">Edad:</label>
                                <input type="number" name="number" id="number" className="font-questrial bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-md focus:ring-primary-600 focus:border-primary-600 block w-11/12 ml-2 p-2.5" placeholder="20" required=""/>
                            </div>
                            <div>
                            ...
                            <button id="sumbitButon" className=" text-white bg-owo hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Registrarse</button>
